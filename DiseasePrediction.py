...
lr1 = Button(root, text="Naive-Byes", height=2, width=10, command=message)
lr1.config(font=("Elephant", 12), background="green")
lr1.grid(row=15, column=0, pady=20)

lr2 = Button(root, text="DecisionTree", height=2, width=10, command=message1)
lr2.config(font=("Elephant", 12), background="green")
lr2.grid(row=16, column=0, pady=20)

lr3 = Button(root, text="RandomForest", height=2, width=10, command=message2)
lr3.config(font=("Elephant", 12), background="green")
lr3.grid(row=17, column=0, pady=20)
